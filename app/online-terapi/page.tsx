...
// sebepten (blog CMS'i ile uyumsuz) elle yazılmış bağımsız bir sayfa
// (bkz. ./content.ts). Panelden "SEO Sayfaları" bölümünden bu slug'a
// (online-terapi) bir kayıt eklenirse oradaki içerik burayı geçersiz kılar;
// kayıt yoksa aşağıdaki `fallback` kullanılır.

const PAGE_SLUG = "online-terapi";
...
function buildJsonLd(content: SeoPageContent) {
  ...
  return {
    ...
    "@graph": [
      ...
      // Sayfaya özgü yeni bir varlık: "online terapi" bir hizmet olarak.
      // Diğer alanlar sitenin tek, paylaşılan işletme kaydına (#business)
      // bağlı kalıyor — ayrı bir "Organization" tekrar tanımlanmadı.
      {
        "@type": "Service",
        "@id": `${pageUrl}#service`,
        name: "Online Terapi",
        alternateName: "Online Psikolog Görüşmesi",
...
export default async function OnlineTerapiPage() {
        ...
        <div className="max-w-3xl mx-auto">
          <article
            className="prose prose-lg max-w-none
              ...
              prose-dt:text-primary prose-dt:font-medium prose-dd:text-primary/70 prose-dd:ml-0
            "
