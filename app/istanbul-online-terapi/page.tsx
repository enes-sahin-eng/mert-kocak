...
// sayfalarıyla aynı sebepten (blog CMS'i ile uyumsuz) elle yazılmış
// bağımsız bir sayfa (bkz. ./content.ts). Panelden "SEO Sayfaları"
// bölümünden bu slug'a (istanbul-online-terapi) bir kayıt eklenirse
// oradaki içerik burayı geçersiz kılar; kayıt yoksa aşağıdaki `fallback`
// kullanılır.

const PAGE_SLUG = "istanbul-online-terapi";
// Breadcrumb'da "Psikolog" ara katmanı atlanıyor — verilen içerikteki
// yapı: Ana Sayfa > İstanbul Psikolog > İstanbul Online Terapi (3 seviye).
const PARENT_SLUG = "istanbul-psikolog";
const PARENT_LABEL = "İstanbul Psikolog";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    // dışı bırakır; verilen başlık zaten kendi marka ekini içeriyor.
    ...
    "@graph": [
      {
        ...
        about: { "@type": "MedicalTherapy", name: "Online psikoterapi" },
        audience: { "@type": "Patient" },
        breadcrumb: { "@id": `${pageUrl}#breadcrumb` },
      },
      // Sayfaya özgü yeni bir varlık: "İstanbul online terapi" bir hizmet
      // olarak. Diğer alanlar sitenin tek, paylaşılan işletme kaydına
      // (#business) bağlı kalıyor — ayrı bir "Organization" tekrar
      // tanımlanmadı.
      {
        "@type": "Service",
        "@id": `${pageUrl}#service`,
        name: "İstanbul Online Terapi",
        alternateName: "İstanbul Online Psikolog",
        serviceType: "Online psikoterapi",
        description: content.metaDescription,
        provider: { "@id": absoluteUrl("/#business") },
        areaServed: { "@type": "City", name: "İstanbul" },
        availableChannel: [
          { "@type": "ServiceChannel", name: "Online seans", serviceUrl: pageUrl },
          {
            "@type": "ServiceChannel",
            name: "Telefon ile randevu",
            servicePhone: { "@type": "ContactPoint", telephone: "+905012648484" },
          },
        ],
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: PARENT_LABEL, item: absoluteUrl(`/${PARENT_SLUG}`) },
...
export default async function IstanbulOnlineTerapiPage() {
