...
// Bu sayfa blog CMS'i (Post modeli) ile uyumlu olmadığı için ayrı bir rota
// olarak elle oluşturuldu. Panelden "SEO Sayfaları" bölümünden bu slug'a
// (psikolog) bir kayıt eklenirse oradaki içerik burayı geçersiz kılar;
// kayıt yoksa aşağıdaki `fallback` (bu klasördeki content.ts) gösterilir.
